 ...
 */
?>
<div id="signup-modal" class="fixed inset-0 z-10 overflow-y-auto hidden">
    ...
    <div class="flex items-center min-h-screen px-4 py-8">
        <div class="relative w-full max-w-lg mx-auto bg-surface rounded-2xl">
            ...
            <form id="signup-form" class="flex flex-col items-center relative p-8 pt-0" method="post">
                <div class="flex justify-center items-center self-start">
                    <div id="close-signup-modal" class="hover:cursor-pointer"><img class="-rotate-90 w-8 h-8 mr-4"
                                                                                    src="https://img.icons8.com/ios-filled/50/000000/long-arrow-up.png"
                                                                                    alt="back to home"/></div>
                    <h1 class="text-4xl font-mono font-poppins font-bold self-start py-8">Sign up</h1>
                </div>
                <p class="font-medium pb-4 self-start text-xl font-poppins text-secondary/60">Welcome to <span
                            class="text-primary">Eagle Flight</span>
                </p>
                <div class="flex flex-col z-10">
                    <div class="my-2">
                        <input class="bg-surface caret-primary w-full text-lg font-medium font-poppins shadow rounded-full my-2 py-3 px-5 outline-none border-2 border-gray-50 focus:border-primary <?php echo $errors['name'] ? 'border-red-600' : ''; ?>"
                             id="name"  type="text" name="name" placeholder="Enter full name">
                        <p id="name-error" class="pl-5 first-letter:uppercase font-poppins text-red-600"></p>
                    </div>
                    <div class="my-2">
                    ...
                    <p class="font-medium text-lg font-poppins text-secondary/60 mt-4 text-center">Already have an
                        account? <span
                                class="text-primary hover:cursor-pointer login-btn">Log in</span></p>
                </div>
            </form>
        </div>
    </div>
