<?php
?>
<div class="fixed top-0 inset-x-1/4 z-10 w-fit mt-12 mx-auto px-4 rounded-md border-l-4 border-green-500 bg-green-100 md:max-w-2xl md:mx-auto animate-slide">
