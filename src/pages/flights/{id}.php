...
<main class="flex flex-col h-full justify-between p-8">
    ...
    <section class="flex justify-evenly">
        <div class="rounded-3xl w-1/3 shadow h-96 hover:scale-105 hover:shadow-lg transition duration-300">
            ...
            <div class="px-4 py-2">
                <h1 class="text-xl font-semibold font-poppins first-letter:uppercase"><?php echo $flight->arrival_city; ?></h1>
                <div class="flex">
                    ...
                    <p class="p-2 text-base text-secondary/60 font-poppins"><?php echo $flight->arrival_country; ?></p>
                </div>
        ...
        <div class="flex flex-col justify-center border border-secondary/10 self-center p-4 shadow rounded-3xl">
            <div class="flex flex-col self-center w-fit text-sm font-medium font-poppins py-2 px-3">
                <div class="flex">
                    <div class="w-52">
                        ...
                        <p class="bg-surface text-base capitalize w-40 font-poppins my-2 mx-6">
                            <?php echo $flight->depart_city . ", " . $flight->depart_country; ?>
                        </p>
                    </div>
                    <div class="w-52">
                        <div class="flex items-center mt-2 px-5">
                        ...
                        <p class="bg-surface text-base capitalize w-40 font-poppins my-2 mx-6">
                            <?php echo $flight->arrival_city . ", " . $flight->arrival_country; ?>
                        </p>
                    </div>
                </div>
                <div class="flex">
                    <div class="w-52">
                        ...
                        <p class="bg-surface text-base capitalize w-40 font-poppins my-2 mx-6">
                            <?php echo date('M j', strtotime($flight->depart_date)) . " - " . date('M j', strtotime($flight->arrival_date)); ?>
                        </p>
                    </div>
                    <div class="w-52">
                        <div class="flex items-center mt-2 px-5">
                ...
                <div class="flex">
                    <div class="w-52">
                        ...
                        <p class="bg-surface text-base capitalize w-40 font-poppins my-2 mx-6">
                            <?php echo $flight->price; ?>$<span class="text-sm lowercase opacity-60">/person</span>
                        </p>
                    </div>
                    <div class="w-52">
                        <div class="flex items-center mt-2 px-5">
                        ...
                        <p class="bg-surface text-base capitalize w-40 font-poppins my-2 mx-6">
                            <?php echo $flight->available_seats; ?><span
                                    class="text-sm lowercase opacity-60">/<?php echo $flight->seats; ?></span>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <?php else: ?>
                <form id="booking-form" class="flex justify-center">
                    <?php
                        csrf();
                    ?>
                    <button
                            ...
                            class="self-center font-medium font-poppins text-gray-100 bg-primary py-3 px-8 rounded-full hover:shadow hover:shadow-primary/70 transition mx-4">
                        Continue
                    </button>
                </form>
            <?php endif; ?>
...
<script src="<?php asset('js/book.js') ?>"></script>
...
return function ($req, $res) {
    ...
    return [
        "flight" => $controller->getFlight($req, $res)
    ];
}
?>
